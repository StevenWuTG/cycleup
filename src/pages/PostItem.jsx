      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 pb-16">
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <form onSubmit={handleSubmit} noValidate className="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-[#e8e0d5] p-6 sm:p-8 space-y-6">
            ...
            {/* Image upload */}
            <div className="border-2 border-dashed border-[#d8f3dc] rounded-2xl p-8 text-center hover:border-[#52b788] hover:bg-[#f0faf3] transition-colors cursor-pointer">
              ...
              <p className="text-xs text-[#a0785a]">PNG, JPG up to 10MB · Up to 5 photos</p>
              <span className="inline-block mt-3 text-xs bg-[#d8f3dc] text-[#2d6a4f] font-medium px-3 py-1 rounded-full">
                Coming soon
              </span>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#2d6a4f] hover:bg-[#1b4332] text-white font-bold py-4 rounded-xl transition-all text-base shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
              <Leaf size={18} />
              Publish Listing
            </button>
